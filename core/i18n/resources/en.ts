...
export const en = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      syncCounts: '{memories} memories, {skills} Skills, {presets} presets, {projects} projects, {projectFiles} project files',
      connectionSuccess: 'Connection succeeded',
      connectionFailed: 'Connection failed',
      uploadConfirm: 'Overwrite remote data with local memories, Skills, presets, and projects?',
      uploadSuccess: 'Upload complete. Remote data was overwritten. {counts}',
      uploadFailed: 'Upload failed',
      downloadConfirm: 'Overwrite local memories, Skills, presets, and projects with remote data? This cannot be undone.',
