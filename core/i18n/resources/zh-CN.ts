...
export const zhCN = {
  ...
  sidepanel: {
    ...
    settings: {
      ...
      syncCounts: '记忆 {memories} 条，Skill {skills} 个，预设 {presets} 个，项目 {projects} 个，项目文件 {projectFiles} 个',
      connectionSuccess: '连接成功',
      connectionFailed: '连接失败',
      uploadConfirm: '确定要用本地记忆、Skill、预设和项目覆盖云端数据吗？',
      uploadSuccess: '上传完成，已覆盖云端。{counts}',
      uploadFailed: '上传失败',
      downloadConfirm: '确定要用云端记忆、Skill、预设和项目覆盖本地数据吗？此操作不可撤销。',
